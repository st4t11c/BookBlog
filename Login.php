...
<div class="navbar">
    ...
    <li style="margin-left: 60%;"><a style="color: white;" href="News.php"><i class="fa fa-info" aria-hidden="true"></i> News</a></li>
</div>
...
<div class="container">
    ...
    <form action="Login.php" method="post" class="form-horizontal">
      ...
      <button><span id="togglePassword" class="toggle-password" onclick="togglePasswordVisibility()">🙈</span></button>
    </div>
